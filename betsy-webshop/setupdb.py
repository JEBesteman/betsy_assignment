...
def create_test_data():
    ...
    ProductTag.create(product=salamon, tag=sports)
    ProductTag.create(product=jacket, tag=clothes)
    ProductTag.create(product=jacket, tag=winter)
    ProductTag.create(product=watch, tag=wearables)
    ProductTag.create(product=watch, tag=sports)
    ProductTag.create(product=sweater, tag=clothes)
    ProductTag.create(product=sweater, tag=winter)
    ProductTag.create(product=energy, tag=food)
    ProductTag.create(product=energy, tag=sports)
